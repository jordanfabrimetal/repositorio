...
function BuscarEquipo(){        
    if($("#codigo").val() == null){
        ...
        }else if($("#tipollamada").val() == 13){
            $.post("../ajax/ascensor.php?op=llamadaservicioauditoriatecnica",{servicecall:$("#codigo").val()}, function(data,status){
                data = JSON.parse(data);
                console.log(data);
                $("#servicecallID").val(data.ServiceCallID);
                $("#customerCode").val(data.CustomerCode);
...
function IniciarServ(){
    ...
    if($("#servicecallID").val() != ''){
        ...
        if($("#tipollamada").val() == 17){
            $.ajax({
                url:'../ajax/servicio.php?op=iniciarsapvisita&servicecallID='+$("#servicecallID").val()+'&customerCode='+$("#customerCode").val()+'&itemcode='+$("#itemcode").val()+'&fm='+$("#fm").val()+'&estado='+$("#status").val()+modnomenclatura+'&gps='+gps+'&subject='+$("#subject").val(),
                type:"GET",
                contentType: false,
                processData:false,
            ...
            $.ajax({
                url:'../ajax/servicio.php?op=iniciarsapauditoriatecnica&servicecallID='+$("#servicecallID").val()+'&customerCode='+$("#customerCode").val()+'&itemcode='+$("#itemcode").val()+'&fm='+$("#fm").val()+'&estado='+$("#status").val()+modnomenclatura+'&gps='+gps+'&subject='+$("#subject").val(),
                type:"GET",
                contentType: false,
                processData:false,
