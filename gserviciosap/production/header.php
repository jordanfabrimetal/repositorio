                        ...
                        <div class="profile clearfix">
                            <div class="profile_pic">
                                <?php if($_SESSION['imagen']):?>
                                    <img src="../files/no-img.png" alt="..." class="img-circle profile_img">
                                <?php else:?>
                                    <img src="../files/no-img.png" alt="..." class="img-circle profile_img">
                                <?php endif;?>
                            </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="">
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                                        ...
                                        <li>
                                            <a href="#" data-href="../../modulosfm/firmatecnico/production/digitalsignature.php?context=firmatecnico" data-toggle="modal" data-target="#modalFirma" class="showModal">
