...
switch ($_GET["op"]) {
    ...
    case 'iniciarsapvisita':
        ...
        $gps = $_GET['gps'];
        $rspta = $ascensor->IniciarServicioVisita($fm,$customerCode,$itemCode,$status,$gps,$subject);
        echo $rspta ? "Servicio iniciado con exito" : "El servicio no pudo ser iniciado";
    break;
    ...
    case 'iniciarsapauditoriatecnica':
        $status = $_GET['estado'];
        if(isset($_GET['nomen']) && isset($_GET['codascen'])){
            $ascensor->ModificaNomenclatura($_GET['codascen'],$_GET['nomen']);
        }
        $gps = $_GET['gps'];
        $rspta = $ascensor->IniciarServicioAuditoriaTecnica($subject,$fm,$customerCode,$itemCode,$status,$gps);
        echo $rspta ? "Servicio iniciado con exito" : "El servicio no pudo ser iniciado";
    break;
