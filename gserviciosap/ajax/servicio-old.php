...
switch ($_GET["op"]) {
                            ...
                            <table>
                                <tr>
                                    <td class="title">
                                        ...
                                        SERVICIO N°<b> ' . $resp["idservicio"] . '</b><br>
                                    </td>              
                                </tr>
                            </table>
                        </td>
    ...
    case 'firmar':
        $idserfirma = isset($_POST["idserfirma"]) ? limpiarCadena($_POST["idserfirma"]) : "";
    ...
    case 'verificarsap':
            ...
            $html = '<br />
                            ...
                            <section class="content invoice">
                                ...
                                <div class="row invoice-info">
                                  ...
                                  <br>
                                    <button class="btn btn-success pull-center" type="button" id="btnVolver" onclick="cancelarform()"><i class="fa fa-close"></i> Volver</button>' . 
                        (($rspta['value'][0]['CallType'] == '1') ? (($ninformes) ? '<button class="btn btn-warning pull-center" type="button" id="btnInforme" onclick="MostrarPreview(\''.((strtolower($datosactividad['value'][0]['artTipoEquipo']) == 'escalera') ? 'informeservicioescalera' : 'informeservicio').'\',\''. $datosactividad['value'][0]['srvCodigo'] . ',' . $datosactividad['value'][0]['equSnInterno'] . ','.((strtolower($datosactividad['value'][0]['artTipoEquipo']) == 'escalera') ? 4 : 3).',' . $datosactividad['value'][0]['actCodigo'] . '\')" ' . $swBtnInforme . '><i class="fa fa-file-pdf-o"></i> Ver Informe de Mantenimiento</button>' : '<button class="btn btn-primary pull-center" type="button" id="btnInforme" onclick="formnewinforme(' . $datosactividad['value'][0]['srvCodigo'] . ',\'' . $datosactividad['value'][0]['equSnInterno'] . '\',\''.((strtolower($datosactividad['value'][0]['artTipoEquipo']) == 'escalera') ? 'informeservicioescalera' : 'informeservicio').'\',' . $datosactividad['value'][0]['actCodigo'] . ')" ><i class="fa fa-check"></i> Terminar Servicio</button><button style="display:none" class="btn btn-warning pull-center" type="button" id="btnInforme2" onclick="MostrarPreview(\''.((strtolower($datosactividad['value'][0]['artTipoEquipo']) == 'escalera') ? 'informeservicioescalera' : 'informeservicio').'\',\''. $datosactividad['value'][0]['srvCodigo'] . ',' . $datosactividad['value'][0]['equSnInterno'] . ','.((strtolower($datosactividad['value'][0]['artTipoEquipo']) == 'escalera') ? 4 : 3).','   . $datosactividad['value'][0]['actCodigo'] . '\')"><i class="fa fa-file-pdf-o"></i> Ver Informe de Mantenimiento</button>') :
                                          '<button class="btn btn-primary pull-center" type="button" id="btnTerminar" onclick="formfinalizar(' . $datosactividad['value'][0]['srvCodigo'] . ',\'' . $datosactividad['value'][0]['equSnInterno'] . '\',\''.((strtolower($datosactividad['value'][0]['artTipoEquipo']) == 'escalera') ? 'informeservicioescalera' : 'informeservicio').'\',' . $datosactividad['value'][0]['actCodigo'] . ')" ' . $swBtnFin . '><i class="fa fa-check"></i> Terminar servicio</button>').'
                                          </div>
                            </section>
                        ';
            echo $html;
                        ...
                        <body>
                            <div class="invoice-box">
                                <table cellpadding="0" cellspacing="0">
                                        ...
                                        <td colspan="2">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <br><br>SERVICIO N°<b> ' . $datosactividad['value'][0]['srvCodigo'] . '</b><br>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr class="item">
                                        <td>
                                            <b>OBSERVACION AL FINALIZAR: </b> ' . $_POST["txtObsFin"] . '
                                        </td>
                                    </tr>';
                                    if($opfirma=='1'){
                                        $bodypdf .= '
                                        ...
                                        <td colspan="2">
                                            <table>
                                                <tr>
                                                    <td class="title">
                                                        <img src="data:image/jpeg;base64," style="width:100%; max-width:300px;"><br><br>
                                                        SERVICIO N°<b> ' . $datosactividad['value'][0]['srvCodigo'] . '</b><br>
                                                    </td>              
                                                </tr>
                                            </table>
                                        </td>
        ...
        case 'lsfsap':
            $rspta = $servicio->LSFSAP();
            $data = Array();
            foreach ($rspta['value'] as $reg) {
                $idas = $imagenMensual->imagen_actividad($reg['actCodigo']);
                $data[] = array(
                    "0" => '<button class="btn btn-info btn-xs" onclick="informesPendientes'.(($idas['contador'] == 0) ? '': 'nuevo').'(' . $reg['actCodigo'] . ')"><i class="fa fa-pencil"></i></button>',
                    "1" => $reg['srvTipoLlamada'],
                    "2" => $reg['equSnInterno'],
                    "3" => $reg['equEdificio'],
                    "4" => date('d-m-Y', strtotime($reg['actFecha'])),
        ...
        case 'formguardarnuevoinforme':
           ...
           // if($opfirma=='1' || $opfirma=='3'){
                ...
                switch($idencuesta){
                    case 5: //informe de mantenimiento
                        ...
                        if(!empty($_FILES['imgfoso']['tmp_name'])){
                            ...
                            $nombreFinal = comprimeImagen($_FILES['imgfoso']['tmp_name'], "../files/images/", $nombre, $extension, 45);
                        ...
                        if(!empty($_FILES['imgtecho']['tmp_name'])){
                            ...
                            $temp= explode('.',$_FILES["imgtecho"]["name"]);
                            $extension = end($temp);
                            $nombreFinal = comprimeImagen($_FILES['imgtecho']['tmp_name'], "../files/images/", $nombre, $extension, 45);
                        ...
                        if(!empty($_FILES['imgmaquina']['tmp_name'])){
                            ...
                            $temp= explode('.',$_FILES["imgmaquina"]["name"]);
                            $extension = end($temp);
                            $nombreFinal = comprimeImagen($_FILES['imgmaquina']['tmp_name'], "../files/images/", $nombre, $extension, 45);
                        ...
                        if(!empty($_FILES['imgoperador']['tmp_name'])){
                            ...
                            $temp= explode('.',$_FILES["imgoperador"]["name"]);
                            $extension = end($temp);
                            $nombreFinal = comprimeImagen($_FILES['imgoperador']['tmp_name'], "../files/images/", $nombre, $extension, 45);
                ...
                if(!empty($_FILES['imgpresupuesto1']['tmp_name'])){
                    ...
                    //move_uploaded_file($_FILES["imgpresupuesto1"]["tmp_name"],"../files/images/" . $_FILES["imgpresupuesto1"]["name"]);
                ...
                if(!empty($_FILES['imgpresupuesto2']['tmp_name'])){
                    ...
                    //move_uploaded_file($_FILES["imgpresupuesto2"]["tmp_name"],"../files/images/" . $_FILES["imgpresupuesto2"]["name"]);
                ...
                if(!empty($_FILES['imgpresupuesto3']['tmp_name'])){
                    ...
                    //move_uploaded_file($_FILES["imgpresupuesto3"]["tmp_name"],"../files/images/" . $_FILES["imgpresupuesto3"]["name"]);
                ...
                if(!empty($_FILES['imagenmensual']['tmp_name']) && !empty($_POST['imagenmensualID'])){
                   ...
                   // move_uploaded_file($_FILES["imagenmensual"]["tmp_name"],"../files/images/" . $idactividad.'_imgmensual_'.$_POST['imagenmensualID'].'_'.time().'.'.$extension);
            ...
            //break;
                $archivo = 'nuevo-FM_IM-' . $rspvisita . '_EQ-' . $idascensor . '_' . $periodo . '.pdf';
                file_put_contents('../files/pdf/' . $archivo, $result);
        ...
        case 'formguardarfirmarinformenuevo':
            ...
            $archivo = 'nuevo-posponer-FM_IM-' . $idinforme . '_EQ-' . $idascensor . '_' . $periodo . '.pdf';
            file_put_contents('../files/pdf/' . $archivo, $result);
