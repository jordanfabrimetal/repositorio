...
require "../config/conexion.php";
	...
	Class Computador{
		...
		public function insertar($idmarca, $modelo, $tcomputador, $serial, $maclan, $macwifi,$factura,$fvencimiento_garantia, $observaciones, $estado){
			$sql="INSERT INTO computador (idmarca, modelo, tcomputador, serial, maclan, macwifi,factura,fvencimiento_garantia,observaciones, estado) VALUES ('$idmarca', '$modelo', '$tcomputador', '$serial', '$maclan', '$macwifi','$factura','$fvencimiento_garantia','$observaciones', '$estado')";
		...
		public function listar(){
			$sql="SELECT c.idcomputador, t.nombre as tipo, m.nombre as marca, c.serial, c.maclan, c.condicion, c.estado, c.disponible,c.modelo FROM computador c INNER JOIN tcomputador t ON c.tcomputador = t.idtcomputador INNER JOIN marcacom m ON c.idmarca = m.idmarcacom";
			return ejecutarConsulta($sql);
		}
