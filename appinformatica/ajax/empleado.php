...
switch ($_GET["op"]) {
	...
	case 'listar':
		...
		while ($reg = $rspta->fetch_object()){
                    ...
                    if($reg->condicion){
                        $boton_act = '<button class="btn btn-danger btn-xs" onclick="desactivar('.$reg->idempleado.')"><i class="fa fa-close"></i></button>';
                    }else{
                        $boton_act = '<button class="btn btn-primary btn-xs" onclick="activar('.$reg->idempleado.')"><i class="fa fa-check"></i></button>';
                    }
                    ...
                    $data[] = array(
                                "0"=>'<button class="btn btn-warning btn-xs" onclick="mostar('.$reg->idempleado.')"><i class="fa fa-pencil"></i></button>'.
                                      $boton_act.
                                      '<button class="btn btn-primary btn-xs" onclick="verFichaEmpleado('.$reg->idempleado.')"><i class="fa fa-id-card"></i></button>'.
                                      $boton_doc.
                                      $boton_correo,                            
