...
function contrato(idasignacion){
	...
	data = JSON.parse(data);
      ...
      var lineSpacing={
        ...
        doc.myText("ANEXO DE CONTRATO DE TRABAJO POR ENTREGA Y USO DE TELEFONO",{align: "center"},startX, startY+=lineSpacing.DobleSpacing);
        ...
        doc.setFontType('normal');
        doc.text(startX+60, startY, "Cable USB, cargador");
	...
	data = JSON.parse(data);
      ...
      var lineSpacing={
        ...
        doc.setFontType('bold');
        doc.setFontSize(fontSizes.TitleFontSize);
        doc.myText("ACTA DE ENTREGA DE TELÉFONO MOVIL",{align: "center"},startX, startY+=lineSpacing.DobleSpacing);
...
function devolucion(idasignacion){
        ...
        if (result !== null) {
            ...
            if(result.length > 0){
              ...
              var ParrafoJSON={
                Inicio:'Yo, VÍCTOR VÁSQUEZ GONZÁLEZ, cédula de identidad nacional 18.122.162-3, en mi calidad de Supervisor TI, declaro recibir en este acto del Sr(a): '+data.nombre+' '+data.apellido+' cédula de identidad número  '+data.num_documento+',  el siguiente elemento a su cargo:',
