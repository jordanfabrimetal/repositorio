...
function pdf(idasigvehi, tipo) {
    console.log("Generando PDF");
    $.post("../ajax/asignacionvehiculo.php?op=pdf", {idasigvehi: idasigvehi, tipo: tipo}, function (data, status) {
        data = JSON.parse(data);
        console.log(data);

        if (data.tipo == 0) {
            var titulo = 'ACTA DE ENTREGA DE VEHICULO';
            var inicodigo ='FF-SS-AC-V-E';
            var subtitulo = "ENTREGA A:";
            var archivo = "ENTREGA";
        } else {
            var titulo = 'ACTA DE DEVOLUCION DE VEHICULO';
        ...
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.DobleSpacing, "EL VEHICULO:");
        ...
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.DobleSpacing, "REVISION DOCUMENTOS: ");
        
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.NormalSpacing, "Padron: ");
        doc.setFontType('normal');
        doc.text(startX + 40, startY, (data.padron == 1)?"OK":"X");
        
        doc.setFontType('bold');
        doc.text(startX + 150, startY, "Revision tecnica: ");
        doc.setFontType('normal');
        ...
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.NormalSpacing, "Permiso de circulacion: ");
        doc.setFontType('normal');
        ...
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.DobleSpacing, "REVISION ACCESORIOS: ");
        ...
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.DobleSpacing, "REVISION MECANICA: ");
        ...
        doc.setFontType('bold');
        doc.text(startX, startY += lineSpacing.NormalSpacing, "Velocimetro: ");
        doc.setFontType('normal');
...
function desactivar_prestamo(idprestamo){
