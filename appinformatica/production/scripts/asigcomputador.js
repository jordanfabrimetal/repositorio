...
function acta(idasigcomputador){
	...
	data = JSON.parse(data);
      ...
      var ParrafoJSON={
        ...
        Jurada2:'Acuerdo formalmente que me sean descontados los gastos provocados por acceder a servicios no habilitados para mi uso, y en general cualquier servicio qué no esté expresamente habilitado para mi.',
        Final:'Asimismo, en caso de finiquito de mi contrato de trabajo, me comprometo a su devolución, sin desmedro del estado en que se encuentre, otorgando a la empresa e derecjo de procedes a su descuento en el caso de que esto no ocurra. La valorización de dicho elementos para su descuento está establecida en el procedimiento interno (Reglamento de Orden, Higiene y Seguridad, Titulo XVII, Art. 56, Letra T).'
      };
      ...
      var lineSpacing={
        ...
        doc.setFontType('normal');
        doc.text(startX+150, startY, data.nombre+' '+data.apellido);
        ...
        doc.setFontType('bold');
        doc.text(startX+150, startY, "CONDICION: ");
        doc.setFontType('normal');
        ...
        doc.setFontSize(fontSizes.SubTitleFontSize);
        doc.setFontType('bold');
        doc.text(startX, startY+=space+lineSpacing.DobleSpacing, "CONFIGURACION ");
        ...
        doc.setFontType('bold');
        doc.text(startX+150, startY, "DIRECCION IP: ");
        doc.setFontType('normal');
          ...
          if (result !== null) {
            ...
            if(result.length > 0){
                ...
                $.post("../ajax/asigcomputador.php?op=pdfdev", {"idasigcompu": idasigcompu, "detalle": result}, function (data, status) {
                        ...
                        var ParrafoJSON = {
                            Inicio: 'Yo, VÍCTOR VÁSQUEZ GONZÁLEZ, cédula de identidad nacional 18.122.162-3, en mi calidad de Supervisor TI, declaro recibir en este acto del Sr(a): ' + data.nombre + ' ' + data.apellido + ' cédula de identidad número  ' + data.num_documento + ',  los siguientes elementos a su cargo:',
                        ...
                        doc.text(startX+150, startY, "CONDICION: ");
                        doc.setFontType('normal');
                        doc.text(startX+150+65, startY, data.condicion);*/
                        ...
                        doc.setFontSize(fontSizes.NormalFontSize);
                        doc.setFontType('normal');
                        doc.text(startX+80, startY, result);
                       ...
                       // doc.text(startX + 150 + 35, startY, data.marca);
                        ...
                        doc.setFontType('bold');
                        doc.text(startX + 300, startY, "Condicion: ");
                        doc.setFontType('normal');
                ...
                /*        //Tarjeta SIM
                        ...
                        doc.setFontType('bold');
                        doc.text(startX + 150, startY, "Numero: ");
                        doc.setFontType('normal');
                        ...
                        doc.setFontType('bold');
                        doc.text(startX + 150, startY, "Telefonia interna: ");
                        doc.setFontType('normal');
                        doc.text(startX + 150 + 85, startY, 'Ilimitada');
                        doc.setFontType('bold');
                        doc.text(startX + 300, startY, "Telefonia: ");
                        doc.setFontType('normal');
                        doc.text(startX + 300 + 50, startY, '150 Minutos');
                        doc.setFontType('bold');
                        doc.text(startX, startY += lineSpacing.DobleSpacing, "Telefonia Internacional: ");
                        doc.setFontType('normal');
                        doc.text(startX + 120, startY, 'N/A');
*/
                        //Se quito la valorizacion del pdf 20210702
                        /*doc.setFontSize(fontSizes.SubTitleFontSize);
                        doc.setFontType('bold');
                        doc.text(startX, startY += lineSpacing.DobleSpacing + lineSpacing.LineSpacing, "Valorización: ");
                        doc.setFontSize(fontSizes.NormalFontSize);
                        doc.setFontType('normal');
                        doc.text(startX + 80, startY, '$ ' + data.precio);*/
                        ...
                        doc.save('Devolucion_Computador_#' + data.idasigcompu + '.pdf');
