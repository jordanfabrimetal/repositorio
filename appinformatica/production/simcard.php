            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div id="listadosimcards" class="x_content">

                    <table id="tblsimcards" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th>Opciones</th>
                          <th>Operador</th>                         
                  ...
                  <div id="formulariosimcard" class="x_content">
                    <br />

                    <div class="col-md-12 center-margin">
	                  <form class="form-horizontal form-label-left" id="formulario" name="formulario">
                           <input type="hidden" id="idsimcard" name="idsimcard" class="form-control">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/simcard.js"></script>
<?php 
}
ob_end_flush();
?>